<template>
  <v-card flat>
    <v-card-title v-if="processing">
      ...
      <a v-if="transactionHash" :href="transactionEtherscanLink" target="_blank"> See it on etherscan</a>
    </v-card-title>
    ...
    <v-card-text v-else>
      <div v-if="transactionFee">
        Estimated deployment gas: <code>{{ gas }} gas ({{ transactionFee }} {{ fiatSymbol }})</code>
      </div>
      <slot></slot>
