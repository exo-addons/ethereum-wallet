      ...
      <template v-if="displayWarnings">
        ...
        <div
          ...
          <wallet-reset-modal
            ...
            @reseted="hideSetPasswordMessage()" />
        </div>
      </template>
    </template>
    <v-snackbar
...
import {watchMetamaskAccount, setWalletBackedUp, skipWalletPasswordSet} from '../WalletUtils.js';
...
export default {
  ...
  computed: {
    displayWarnings() {
      return !this.warningsClosed && (this.displayWalletBackup || this.displayResetPassword);
    },
    ...
    displayResetPassword() {
      return !this.loading && !this.isAdministration && this.walletAddress && !this.useMetamask && this.browserWalletExists && !this.skipWalletPasswordSet && this.autoGenerated;
    },
  },
  watch: {
    refreshIndex() {
