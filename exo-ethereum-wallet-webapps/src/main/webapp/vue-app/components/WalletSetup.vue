...
export default {
  ...
  computed: {
    displayWalletNotExistingYet() {
      return !this.isAdministration && this.isSpace && !this.isSpaceAdministrator && !this.walletAddress;
    },
    ...
    displayWalletBackup() {
      return !this.isAdministration && this.walletAddress && !this.useMetamask && this.browserWalletExists && !this.browserWalletBackedUp;
    },
